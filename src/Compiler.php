...
class Compiler
{
    ...
    /**
     * Compiles SdBot into a single phar file
     *
     * @param  string            $pharFile The full path to the file to create
     * @throws \RuntimeException
     */
    public function compile($pharFile = 'sdbot.phar')
    {
        ...
        $phar = new \Phar($pharFile, 0, 'sdbot.phar');
...
<?php
/*
 * This file is part of StreamDefenseBot.
 *
 * (c) Konstantin Kuklin <konstantin.kuklin@gmail.com>
 *
